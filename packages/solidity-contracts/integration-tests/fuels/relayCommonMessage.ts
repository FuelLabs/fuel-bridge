...
// const contractMessagePredicate = _contractMessagePredicate;
// const contractMessageScript = _contractMessageScript;
...
export async function relayCommonMessage(
  ...
  let messageRelayDetails: CommonMessageDetails | null = null;
