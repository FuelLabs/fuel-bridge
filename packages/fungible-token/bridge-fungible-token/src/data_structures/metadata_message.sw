...
impl MetadataMessage {
    ...
    pub fn parse(msg_idx: u64) -> Self {
        ...
        let symbol_offset: u64 = <u64 as TryFrom<u256>>::try_from(
        ...
        let name_offset: u64 = <u64 as TryFrom<u256>>::try_from(
            b256::from(input_message_data(msg_idx, OFFSET_NAME_PTR)).as_u256()
        ).unwrap();
...
fn get_string_from_evm_bytes(evm_bytes: Bytes) -> String {
    ...
    let len: u64 = <u64 as TryFrom<u256>>::try_from(
        b256::from(evm_bytes).as_u256()
    ).unwrap();
